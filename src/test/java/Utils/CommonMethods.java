...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication(){
        ...
        initializePageObjects();//this will initialize all the pages we have in our PageInitializer Class along with the launching
        // to configure the file and pattern it has
        DOMConfigurator.configure("log4j.xml");//just once
    ...
    public static byte[] takeScreenShot(String imageName ){
        TakesScreenshot ts=(TakesScreenshot)driver; //this cast the webDriver instance 'driver' to takeScreenshot Interface
        //this captures the ScreenShots and stores it as byte array
        byte [] picBytes =ts.getScreenshotAs(OutputType.BYTES);
        //this captures the screenshot and stores it as a file in a source file variable
